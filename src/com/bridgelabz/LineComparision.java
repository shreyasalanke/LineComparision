...
public class LineComparision
{
	...
	public static void main(String[] args) 
	{
		...
		Scanner s = new Scanner(System.in);
        	System.out.println("Enter x co-ordinate of first point x1: ");
       		 int x1 = s.nextInt();
        	System.out.println("Enter y co-ordinate of first point y1: ");
        	int y1 = s.nextInt();
        	System.out.println("Enter x co-ordinate of second point x2: ");
        	int x2 = s.nextInt();
        	System.out.println("Enter y co-ordinate of second point y2: ");
        	int y2 = s.nextInt();
